...
{
    /// <remarks>
    /// Taken from https://stackoverflow.com/questions/30054517/get-image-dimensions-directly-from-url-c-sharp
    /// </remarks>
    public static class ImageTools
    {
        ...
        public static Size GetWebDimensions(string url)
        {
            if (string.IsNullOrWhiteSpace(url))
                throw new ArgumentNullException(nameof(url));

            return GetWebDimensions(new Uri(url));
        }
